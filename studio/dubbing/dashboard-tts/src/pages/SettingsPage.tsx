...
export default function SettingsPage() {
  ...
  const handleConnectTelegram = async () => {
    ...
    try {
      ...
      if (data.nonce) {
        window.open(`https://t.me/PirdDubbingBot?start=${data.nonce}`, "_blank");
      } else {
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-ink-300 text-sm max-w-md mb-6">
                  Connect your Telegram account to upload videos, receive dubbing updates, and manage your tasks directly through our official Telegram bot (@PirdDubbingBot).
                </p>
                {telegramError && (
